...
class Step3b extends Component {
  constructor(props) {
    super(props);
          ...
          <form id="Form" className="form-horizontal">
            <div className="form-group">
              <label className="col-md-12 control-label">
                <h1>Step 3b: Basic JavaScript Validation Example using Redux Component</h1>
              </label>
            </div>
...
export default connect(null, null, null, { withRef: true })(Step3b);
